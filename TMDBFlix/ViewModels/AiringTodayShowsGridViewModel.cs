...
{
    public class AiringTodayShowsGridViewModel : Observable
    {
        ...
        public async Task LoadData()
        {
            ...
            {
                loading = true;
                var AiringTodayshows = await Task.Run(() => TMDBService.GetAiringTodayShows(loadedPages + 1));
        ...
        public AiringTodayShowsGridViewModel()
        {
