...
{
    public class PopularShowsGridViewModel : Observable
    {
        ...
        public async Task LoadData()
        {
            ...
            {
                loading = true;
                var Popularshows = await Task.Run(() => TMDBService.GetPopularShows(loadedPages + 1));
        ...
        public PopularShowsGridViewModel()
        {
