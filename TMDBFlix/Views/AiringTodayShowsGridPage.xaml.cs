...
{
    public sealed partial class AiringTodayShowsGridPage : CustomPage
    {
        public AiringTodayShowsGridViewModel ViewModel { get; } = new AiringTodayShowsGridViewModel();

        public AiringTodayShowsGridPage()
        {
            InitializeComponent();
