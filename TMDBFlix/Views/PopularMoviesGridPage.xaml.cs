...
{
    public sealed partial class PopularMoviesGridPage : CustomPage
    {
        public PopularMoviesGridViewModel ViewModel { get; } = new PopularMoviesGridViewModel();

        public PopularMoviesGridPage()
        {
            InitializeComponent();
