...
{
    public sealed partial class PopularShowsGridPage : CustomPage
    {
        public PopularShowsGridViewModel ViewModel { get; } = new PopularShowsGridViewModel();

        public PopularShowsGridPage()
        {
            InitializeComponent();
