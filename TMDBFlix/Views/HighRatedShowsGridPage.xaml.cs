...
{
    public sealed partial class HighRatedShowsGridPage : CustomPage
    {
        public HighRatedShowsGridViewModel ViewModel { get; } = new HighRatedShowsGridViewModel();

        public HighRatedShowsGridPage()
        {
            InitializeComponent();
