...
{
    public sealed partial class UpcomingMoviesGridPage : CustomPage
    {
        public UpcomingMoviesGridViewModel ViewModel { get; } = new UpcomingMoviesGridViewModel();

        public UpcomingMoviesGridPage()
        {
            InitializeComponent();
